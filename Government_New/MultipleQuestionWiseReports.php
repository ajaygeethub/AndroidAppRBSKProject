...
<form name=f1 method=post>	
              ...
              <div class="panel" style='border:1px solid #FF5050;color:white'>
                ...
                if(isset($_POST['find'])) 
				{
                    ...
                    $result1 = mysql_query("select question,qid from question where cid=2 or cid=3 or cid=4");
            ...
            <div class="table-fixed"><table class="table table-bordered border-0">';
					...
					foreach($d as $question)
					{
							...
							$sql1="select count(a.answer) from questionanswer a,question q where q.qid=a.qid and q.question='".$question."' and answer='Y'";
							$result1=mysql_query($sql1);
							$answerY=mysql_fetch_array($result1);
							$yes+=$answerY[0];
							
							
							$sql2="select count(a.answer) from questionanswer a,question q where q.qid=a.qid and q.question='".$question."' and answer='N'";

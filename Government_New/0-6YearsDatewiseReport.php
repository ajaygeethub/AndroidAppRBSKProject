			...
			<form name=f1 method=post>
			 <div class="panel" style='border:1px solid #FF5050;color:white;radius:0px'>
				...
				<?php
							...
							{
							$sql="select c.date,c.ChildName,c.mother,c.father,c.Gender,u.username,c.ChildId from CHildrenDetails c,user u where u.userid=c.uid and (c.date between '".$_POST['ToDate']."' and '".$_POST['FromDate']."')";
							$result=mysql_query($sql);
							echo "<div class=table-responsive>";
							echo "<table class='table table-bordered' id=d>";
							
							echo "<thead><tr><th>Srno</th><th>Date</th><th>Name</th><th>Mother Name</th><th>Father Name</th><th>Gender</th><th>Username </th><th>View Answer</th><th>Delete</th></tr></thead><tbody>";
							$srno=0;
							while($dataset=mysql_fetch_array($result))
								{
									
									$srno+=1;
									echo "<tr><td>".$srno."</td><td>".date("d-m-Y",strtotime($dataset[0]))."</td><td>".$dataset[1]."</td><td>".$dataset[2]."</td><td>".$dataset[3]."</td><td>".$dataset[4]."</td><td>".$dataset[5]."</td><td><a href=0-6YearsQuestionReport.php?n=".$dataset[6].">View</a></td><td><a href=0-6YearsQuestionDelete.php?n=".$dataset[6].">Delete</a></td></tr>";

		...
		<form name=f1 method=post>
			 <div class="panel" style='border:1px solid #FF5050;color:white;radius:0px'>
				...
				<?php
							...
							echo "<tr><th>Question</th><th>Yes</th><th>No</th></tr>";
							echo "<tr><td class=title>".$question[0]."</td>";
							...
							{
							$sql="select question,qid from question where cid=2 or cid=3 or cid=4";
							$result=mysql_query($sql);
							echo "<div class=table-responsive>";
							echo "<table class='table table-bordered'>";
							...
							$sql1="select count(answer) from questionanswer where qid=".$question[1]." and answer='Y'";
							$result1=mysql_query($sql1);
							$answerY=mysql_fetch_array($result1);
							
							
							
							$sql2="select count(answer) from questionanswer where qid=".$question[1]." and answer='N'";
							$result2=mysql_query($sql2);
							$answerN=mysql_fetch_array($result2);
